...
export class DatabaseInNestJs1644798541789 implements MigrationInterface {
    name = 'DatabaseInNestJs1644798541789'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`traceabilities\` (\`id\` int NOT NULL AUTO_INCREMENT, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`agent\` json NOT NULL, \`clientIp\` varchar(255) NOT NULL, \`requestId\` varchar(255) NOT NULL, \`endpoint\` varchar(255) NOT NULL, \`httpMethod\` varchar(255) NOT NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
